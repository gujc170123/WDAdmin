...
class FactOEI(models.Model):
    ...
    X1 = models.DecimalField(max_digits=5, decimal_places=2)
    X2 = models.DecimalField(max_digits=5, decimal_places=2)
    X3 = models.DecimalField(max_digits=5, decimal_places=2)
    X4 = models.DecimalField(max_digits=5, decimal_places=2)
    X5 = models.DecimalField(max_digits=5, decimal_places=2)
    X6 = models.DecimalField(max_digits=5, decimal_places=2)
    X7 = models.DecimalField(max_digits=5, decimal_places=2)
    X8 = models.DecimalField(max_digits=5, decimal_places=2)
    X9 = models.DecimalField(max_digits=5, decimal_places=2)
    X10 = models.DecimalField(max_digits=5, decimal_places=2)
    X11 = models.DecimalField(max_digits=5, decimal_places=2)
    X12 = models.DecimalField(max_digits=5, decimal_places=2)
    X13 = models.DecimalField(max_digits=5, decimal_places=2)
    X14 = models.DecimalField(max_digits=5, decimal_places=2)
    X15 = models.DecimalField(max_digits=5, decimal_places=2)
