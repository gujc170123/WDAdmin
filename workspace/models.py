...
class FactOEI(models.Model):
    ...
    DW_Person_ID = models.IntegerField(db_index=True)
    organization1 = models.IntegerField(db_index=True, null=True, blank=True)
    organization2 = models.IntegerField(db_index=True, null=True, blank=True)
    organization3 = models.IntegerField(db_index=True, null=True, blank=True)
    organization4 = models.IntegerField(db_index=True, null=True, blank=True)
    organization5 = models.IntegerField(db_index=True, null=True, blank=True)
    organization6 = models.IntegerField(db_index=True, null=True, blank=True)
    profile1 = models.IntegerField(db_index=True, null=True, blank=True, verbose_name="年龄")
    profile2 = models.IntegerField(db_index=True, null=True, blank=True, verbose_name="性别")
    profile3 = models.IntegerField(db_index=True, null=True, blank=True, verbose_name="岗位序列")
    profile4 = models.IntegerField(db_index=True, null=True, blank=True, verbose_name="工龄")
    profile5 = models.IntegerField(db_index=True, null=True, blank=True, verbose_name="层级")
    profile6 = models.IntegerField(db_index=True, null=True, blank=True)
    profile7 = models.IntegerField(db_index=True, null=True, blank=True)
    profile8 = models.IntegerField(db_index=True, null=True, blank=True)
    profile9 = models.IntegerField(db_index=True, null=True, blank=True)
    profile10 = models.IntegerField(db_index=True, null=True, blank=True)
