...
Reports = {
    ...
    'mbti2019f':"http://reporttest.iwedoing.com:9090/api/render?url=http://reporttest.iwedoing.com/TemplateNewBehavioralStyle/?people_result_id=%s&emulateScreenMedia=false",
}
#
